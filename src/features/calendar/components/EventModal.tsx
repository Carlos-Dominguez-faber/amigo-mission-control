...
export function EventModal({ mode, defaultDayOfWeek, event, onClose, onSubmit, onDelete }: EventModalProps) {
  ...
  return (
    ...
    >
      <div className="bg-[#16181a] rounded-2xl border border-[#272829] w-full max-w-md max-h-[90vh] flex flex-col overflow-hidden shadow-2xl">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-[#272829]">
          <h2 id="event-modal-title" className="text-sm font-semibold text-white">
